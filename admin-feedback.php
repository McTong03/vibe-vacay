...
<body>
            ...
            <?php foreach ($reviews as $review): ?>
                <div class="batu-container">
                    ...
                    <div class="trash-container">
                        <button class="trash-button" onclick="confirmDeleteReview(<?php echo $review['review_id']; ?>, <?php echo $destination_id; ?>, '<?php echo addslashes(htmlspecialchars($review['user_name'])); ?>')">
    ...
    <script>
        ...
        function confirmDeleteReview(review_id, destination_id, user_name) {
            if (!confirm('Are you sure you want to delete this review?\n\nReview ID: ' + review_id + '\nReviewed by: ' + user_name)) return;
            window.location.href = 'delete-review.php?id=' + review_id + '&destination_id=' + destination_id;
        }
    </script>
